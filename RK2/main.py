...
def links(catalogs, files, files_catalogs):
    """Функция для создания связей"""
...
def exercise1(catalogs, files, files_catalogs):
    """Функция для задания 1"""
    one_to_many, many_to_many = links(catalogs, files, files_catalogs)
    res_11 = list(filter(lambda i: i[0][0] == "A", one_to_many))
    return res_11


def exercise2(catalogs, files, files_catalogs):
...
def exercise3(catalogs, files, files_catalogs):
...
def main():
    ...
    print('Задание В1')
    print(exercise1(catalogs, files, files_catalogs))

    print('\nЗадание В2')
    print(exercise2(catalogs, files, files_catalogs))

    print('\nЗадание В3')
    print(exercise3(catalogs, files, files_catalogs))
